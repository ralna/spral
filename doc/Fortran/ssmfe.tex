...
%require the user to take %the following %user's code 
%action.
%
\begin{description}
%
...
%
\itt{rci} is an \intentinout\  scalar  of type
{\tt \solver\_rcid} in real version and
{\tt \solver\_rciz} in complex version.
...
\begin{description}
%
\itt{sigma} is an \intentin\ scalar of type \REALDP\
...
Negative values are treated as the default.
%
\itt{max\_it} is a scalar of type default \Integer\ that
...
Negative values are treated as the default.
%
\itt{tol\_vector} is a scalar of type \REALDP\ %default \Double\ 
