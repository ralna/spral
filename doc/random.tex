\packagename{RANDOM}
\version{1.0.0}
\versiondate{7 Arpil 2014}
\purpose{
   This package generates pseudo-random numbers using a linear congruential
   generator. It shuold generate the same random numbers using any standards
   compliant Fortran compiler on any archictecture so long as the default
