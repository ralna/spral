...
\subsection{\texttt{ssmfe()} and \texttt{ssmfe\_largest()}} \label{ssmfe:routine:ssmfe}
...
%
\itt{options} is an \intentin\  scalar  of type {\tt ssmfe\_core\_options}.
...
\subsection{\texttt{ssmfe\_core\_options}} \label{ssmfe:type:options}
...
\subsection{\texttt{ssmfe\_infrom}} \label{ssmfe:type:inform}
