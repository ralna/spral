...
\begin{description}
%
\itt{abs\_tol\_lambda} is a scalar of type
\REALDP\ that
...
%
\itt{abs\_tol\_residual} is a scalar of type
\REALDP\ that
...
%
\itt{rel\_tol\_lambda} is a scalar of type
\REALDP\ that
...
Negative values are treated as the default.
%
\itt{rel\_tol\_residual} is a scalar of type
\REALDP\ that
...
Negative values are treated as the default.
%
\itt{tol\_x} is a scalar of type \REALDP\ that
